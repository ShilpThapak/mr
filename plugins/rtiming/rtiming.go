...
func Map(filename string, contents string) []models.KeyValue {
	...
	kva := []models.KeyValue{}
	kva = append(kva, models.KeyValue{"a", "1"})
	kva = append(kva, models.KeyValue{"b", "1"})
	kva = append(kva, models.KeyValue{"c", "1"})
	kva = append(kva, models.KeyValue{"d", "1"})
	kva = append(kva, models.KeyValue{"e", "1"})
	kva = append(kva, models.KeyValue{"f", "1"})
	kva = append(kva, models.KeyValue{"g", "1"})
	kva = append(kva, models.KeyValue{"h", "1"})
	kva = append(kva, models.KeyValue{"i", "1"})
	kva = append(kva, models.KeyValue{"j", "1"})
	return kva
}
